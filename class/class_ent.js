class Class_Ent extends Class_Sprite{
    constructor(canvas, context, x=0, y=0, width=20, height=38.4, color="Blue"){
        ...
        this.dictionary_sprite_sheet.idle = sprite_sheet_ent_idle;
        this.dictionary_sprite_sheet.walk = sprite_sheet_ent_walk;
        this.dictionary_sprite_sheet.fall = sprite_sheet_ent_fall;
        this.dictionary_sprite_sheet.attack = sprite_sheet_ent_attack;
        this.dictionary_sprite_sheet.hit = sprite_sheet_ent_hit;
        ...
        this.range_attack = 75;
        this.health_max = 200;
        this.health = this.health_max;
        this.damage = 100;

        this.dictionary_audio.fall = audio_ent_fall;
    ...
    update_index_column_in_sprite_sheet(){
        ...
        if (this.status == Enum_Sprite_Status.attack && this.index_column_in_sprite_sheet === 7){
    ...
    update_sprite_sheet_info(){
        ...
        if (this.status == Enum_Sprite_Status.idle){
            ...
            this.count_sprite_sheet_column = 24;
            ...
            this.fraction_destination_width = 6.0;
            ...
            this.count_sprite_sheet_column = 32;
            this.count_sprite_sheet_row = 8;
            ...
            this.count_sprite_sheet_column = 22;
            this.count_sprite_sheet_row = 8;
