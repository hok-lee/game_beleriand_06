class Class_Orc extends Class_Sprite{
    constructor(canvas, context, x=0, y=0, width=15, height=30, color="Black"){
        ...
        this.dictionary_sprite_sheet.walk = sprite_sheet_orc_walk;
        this.dictionary_sprite_sheet.fall = sprite_sheet_orc_fall;
        this.dictionary_sprite_sheet.attack = sprite_sheet_orc_attack;
        this.dictionary_sprite_sheet.hit = sprite_sheet_orc_hit;
        // more sprite sheets?
    ...
    update_sprite_sheet_info(){
        ...
        if (this.status == Enum_Sprite_Status.walk){
            ...
            this.time_interval_change_sprite = 25;
            this.time_since_last_change_sprite = 0;
