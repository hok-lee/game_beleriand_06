class Class_Spider extends Class_Sprite{
    constructor(canvas, context, x=0, y=0, width=15, height=15, color="Black"){
        ...
        this.time_interval_attack = 2000;
        this.time_since_last_attack = this.time_interval_attack + 1;
        this.range_attack = 2*this.width;

        this.dictionary_sprite_sheet.walk = sprite_sheet_spider_walk;
        this.dictionary_sprite_sheet.fall = sprite_sheet_spider_fall;
        this.dictionary_sprite_sheet.attack = sprite_sheet_spider_attack;
        this.dictionary_sprite_sheet.hit = sprite_sheet_spider_hit;
        // more sprite sheets?
    ...
    update_index_column_in_sprite_sheet(){
        ...
        if (this.status == Enum_Sprite_Status.attack && this.index_column_in_sprite_sheet === 2){
    ...
    update_sprite_sheet_info(){
        ...
        if (this.status == Enum_Sprite_Status.walk){
            ...
            this.time_interval_change_sprite = 20;
            ...
            this.fraction_destination_width = 5.6;
            this.fraction_destination_height = 2.5;
            ...
            this.fraction_destination_height = 3.6;
